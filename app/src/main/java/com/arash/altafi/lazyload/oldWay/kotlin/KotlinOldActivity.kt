package com.arash.altafi.lazyload.oldWay.kotlin
...
import com.arash.altafi.lazyload.oldWay.kotlin.adapter.AdapterCelebrities
import com.arash.altafi.lazyload.oldWay.kotlin.api.ApiClient
import com.arash.altafi.lazyload.oldWay.kotlin.api.ApiService
...
class KotlinOldActivity : AppCompatActivity() {
        ...
        apiService.lazyLoad("ترلان پروانه", page, 5)
            ...
            .subscribe(object : SingleObserver<List<ResponseCelebrities>> {
                ...
                override fun onError(e: Throwable) {
                    Toast.makeText(this@KotlinOldActivity, e.message, Toast.LENGTH_LONG).show()
                }
